...
do {
    const nome = prompt("Digite o nome do seu cliente:")
    const cpf = prompt("digite o cpf do seu cliente")   
    const valor = parseInt(prompt("Qual o valor que será movimentado?"))
